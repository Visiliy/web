    ...
    if request.method == 'GET':
        return f'''<!doctype html>
                        <html lang="en">
                          ...
                          <body>
                            <center><h1>Загрузка фотографиии</h1></center>
                            <center><h2>для учасника миссии</h2></center>
                            <div>
                                <form class="login_form" method="post">
                                        <div class="form-group">
                                            <label for="photo">Приложите фотографию</label>
                                        ...
                                        <h6><br></h6>
                                        <img src="/static/img/star.jpg" width="300px">
                                        <h6><br></h6>
                                    <button type="submit" class="btn btn-primary">Отправить</button>
                                </form>
                            </div>
        ...
        s = request.form['file']
        p = os.path.abspath(request.form['file'])
        return f'''<!doctype html>
                                <html lang="en">
                                  <head>
                                    <meta charset="utf-8">
                                  ...
                                  <body>
                                    ...
                                    <div>
                                        <form class="login_form" method="post">
                                                ...
                                                <h6><br></h6>
                                                <img src=/static/img/{s} width="300px">
                                                <h6><br></h6>
                                            <button type="submit" class="btn btn-primary">Отправить</button>
                                        </form>
                                    </div>
